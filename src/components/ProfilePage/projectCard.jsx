    ...
    return(
        <>
            <div className="project-card">
                <img className="project-pic" src="https://media.istockphoto.com/id/1018078858/photo/gorgeous-ginger-cat-on-isolated-black-background.webp?b=1&s=170667a&w=0&k=20&c=EwlaB19d5gWoUp_8O71QU22eAzTcittlZ-A_-EwYgnk=" alt="project" ></img>
